<footer>
    <section class="top-line">
        <div style="background: url(<?= base_url("Themes/cars/dark/") ?>img/footer.jpg) repeat scroll 50% 422.28px transparent;" class="parallax scrolly-invisible no-parallax blackish"></div><!-- PARALLAX BACKGROUND IMAGE -->	
        <div class="container">
            <div class="row">   
