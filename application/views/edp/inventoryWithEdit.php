                                                        ...
                                                        <div class="ibox-content">
                                                            ...
                                                            <form method="post" name="editStock" action="<?= ADMINURL ?>edp/addRep" class="form-horizontal">
                                                                ...
                                                                <div class="col-md-5 border">
                                                                    ...
                                                                    <br>
                                                                    <div class="custom-file">
                                                                        <input  type="file" name="upload_file" required="required" class="custom-file-input" id="custom-file-input-colour">
                                                                        <label for="custom-file-input" class="custom-file-label" >Choose file...</label>
                                                                    </div> 
                                                                    <div >
                                                                        <br>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content animated fadeIn">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        <form>
                                                            <div class="form-group row">
                                                                <input type="number"  placeholder="Starting Row Number eg: 1" class="form-control" min="1" id="start_col" required="required" >
                                                            </div>


                                                            <div class="form-group row">
                                                                <select class="form-control" style="color:success" required="required">
                                                                    <option value="">Header Option</option>
                                                                    <option value="0">Header Excluded</option>
                                                                    <option value="1">Header Included</option>
                                                                </select>
                                                            ...
                                                            <div class="form-group row">
                                                                <select class="form-control sheetDrop" style="color:success" id="sheetNameList" required="required">
                                                                    <option value="">Select Sheet Name</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group row">
                                                                <select class="form-control repDrop" style="color:success" id="repNameList" required="required">
                                                                    <option value="">Select Report Name</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group row">
                                                                <input type="number" name="ending_row" placeholder="max 50 rows allowed" class="form-control" min="1" id="end_row"required="required">
                                                            </div>                           
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <input type="submit" class="btn btn-primary"  id="addColExcelBtn" value="Add">
                                                                </div>
                                                            </div>
