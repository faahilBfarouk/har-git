                                            ...
                                            <?php if (!empty($data)) { ?>
                                                ...
                                                <?php foreach ($data as $key => $value): ?>
                                                    <tr>
                                                        ...
                                                        <?php endforeach; ?>
                                                        <td>
                                                            <button class="btn btn-success editBtn" name="editBtn"id="editBtn" data-toggle="modal" data-id="<?= $value['enquiry_report_id'] ?>" data-target="#myModal5" type="button">Edit/Delete</button>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php } ?>
