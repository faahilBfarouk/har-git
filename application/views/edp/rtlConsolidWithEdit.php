...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h2>RTL Consolidated Report Table</h2>
                                <p class="text-muted"> Kindly use the actual form to add items to this table</p>
                                <form method="POST" action="<?php echo ADMINURL ?>edp/rtlConsolidatedRep">
                                            ...
                                            <?php if (!empty($data)) { ?>
                                                ...
                                                <?php foreach ($data as $key => $value): ?>
                                                    <tr>
                                                        ...
                                                        <?php endforeach; ?>
                                                        <td>
                                                                                                                <button class="btn btn-success editBtn" data-toggle="modal" data-id="<?= $value['rtl_rep_id'] ?>" data-target="#myModal5" type="button">Edit/Delete</button>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php } ?>
                        ...
                        <div class="modal-content animated fadeIn">
                            ...
                            <div class="modal-body text-center">
                                <form method="post" id="editForm" action="<?= ADMINURL ?>edp/editRep" class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">MUL INV Date </label>

                                        <div class="col-sm-10">
                                            <input style=" width: 150px !important;" id="MUL_INV_date" name="MUL_INV_date" placeholder="MM/DD/YYY" type="text" autocomplete="off"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var date_input2 = $('input[name="orderDate"]');
             var date_input3 = $('input[name="MUL_INV_date"]');
...
<script>
            ...
            //console.log(admin_url)
                ...
                document.getElementById("table").value = 'rtl_daily_rep';
                ...
                success: function (data) {
                   ...
                   // $('.tableRow').remove()
                    $.each(data, function (key, val) {
                        ...
                        document.getElementById("MUL_INV_date").value = val['Mul_inv_dt'];
                       ...
                       document.getElementById("orderNum").value = val['order_number'];
