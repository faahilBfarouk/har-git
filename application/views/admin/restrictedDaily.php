                    ...
                    <div class="col-sm-12">
                        <div class="ibox">
                            <div class="ibox-title">
                                ...
                                <form method="POST" action="<?php echo base_url() ?>admin/AdminArea/restrictedDailyRep">
                            ...
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php if (!empty($data['me'])) { ?>
                                                <tr>                                                                                                                        
                                                    <td><input readonly="readonly" type="text" class="label label-success border-0" style="width:125px;" value="<?= $data['me']['rep'][0]['emp name'] ?>"></td>

                                            <b> <td> <span class="text-danger"><?= $data['me']['rep'][0]['countEnq'] ?></span></td> </b>
                                            <b> <td> <span class="text-info"><?= $data['me']['rep'][0]['countBkg'] ?></span></td> </b>
                                            <b> <td> <span class="text-warning"><?= $data['me']['rep'][0]['countRtl'] ?></span></td> </b>
                                            <b> <td> <span class="text-success"><?= $data['me']['rep'][0]['countDel'] ?></span></td> </b>
                                            <b> <td> <span class="text-primary"><?= $data['me']['rep'][0]['countCan'] ?></span></td> </b>
                                            </tr>
                                        <?php } ?>

                                        <?php if (!empty($data['child'])) { ?>
                                            <?php foreach ($data['child'] as $value): ?>
                                                <tr>
                                                    <td><input readonly="readonly" type="text" class="label label-success border-0" style="width:125px;" value="<?= $value['rep'][0]['emp name'] ?>"></td>

                                                <b> <td> <span class="text-danger"><?= $value['rep'][0]['countEnq'] ?></span></td> </b>
                                                <b> <td> <span class="text-info"><?= $value['rep'][0]['countBkg'] ?></span></td> </b>
                                                <b> <td> <span class="text-warning"><?= $value['rep'][0]['countRtl'] ?></span></td> </b>
                                                <b> <td> <span class="text-success"><?= $value['rep'][0]['countDel'] ?></span></td> </b>
                                                <b> <td> <span class="text-primary"><?= $value['rep'][0]['countCan'] ?></span></td> </b>
