                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content text-center">
                                ...
                                <form method="post" action="<?= ADMINURL ?>sales/insert_booking"name="bookingDetailsForm" class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input autocomplete="off" type="text" required="required" placeholder="customer name" name="custName" id="custName" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input autocomplete="off" type="number" required="required" placeholder="Phone No" name="customer_number" id="customer_number" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
