...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="ibox">
                            ...
                            <form method="POST" action="<?= ADMINURL ?>sales/salesModelRepView" name="dateForm"id="dateForm">
                                <div class="row">                        
                                    <div class="col-md-6">
                                        <div class="form-group" id="data_5">
                                            <div class="input-daterange input-group" id="datepicker" name="daterange">
                                                <input readonly="readonly" style="background-color: white;" type="text" class="input-sm form-control" name="start" id="from" value="" autocomplete="off"/>
                                                <span class="input-group-addon">to</span>
                                                <input readonly="readonly" style="background-color: white;" type="text" class="input-sm form-control" name="end" id='to' autocomplete="off" value=""/>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        let admin_url = "<?php echo ADMINURL ?>";
        ...
        $(document).ready(function () {
            ...
            $('.testbtn').click(function () {
                ...
                variantUp('sales/salesJsoniser', model, table);
