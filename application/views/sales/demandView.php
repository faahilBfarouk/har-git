...
<body>
                                    ...
                                    <table class="table dataTable table-bordered table-hover dataTables-example" style="width:100%">
                                        ...
                                        <tbody id="demandTableBody">
                                            <tr id="demandTableRow">
                                                ...
                                                <td>
                                                    <button class="btn btn-success demandConvertBtn " name="demandConvertBtn[]" id="demandConvertBtn_1" type="button">Convert</button>
                                                </td>
                                                <td>
                                                    <button class="btn btn-success demandDestroy " name="demandDestroy[]" id="demandDestroy_1" type="button">Colours</button>
    ...
    <script src="<?= ADMINTHEME ?>scripts/viewDemand.js"></script>
