                    ...
                    <div class="col-sm-12">
                        <div class="ibox">
                            <div class="ibox-title">
                                ...
                                <form method="POST" action="<?php echo base_url() ?>admin/sales/salesDaily">
                                ...
                                <table class="table  table-hover">
                                    ...
                                    <tbody>
                                        <?php if (!empty($data['me'])) { ?>
                                            <tr>
                                                <td><p class="badge badge-danger" style="width:125px"><?= $data['me']['rep'][0]['emp name'] ?></p></td>
                                    ...
                                    <?php if (!empty($data['child'])) { ?>
                                        <?php foreach ($data['child'] as $value): ?>
                                            <tr>
                                                <td><p class="badge badge-danger" style="width:125px"><?= $value['rep'][0]['emp name'] ?></p></td>
